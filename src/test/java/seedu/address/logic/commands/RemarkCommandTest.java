...
class RemarkCommandTest {
    ...
    void execute_addRemarkUnfilteredList_success() {
        ...
        Person editedPerson = personInList.withRemark(VALID_REMARK).build();

        RemarkCommand remarkCommand = new RemarkCommand(indexLastPerson, new Remark(editedPerson.getRemark().value));
    ...
    void execute_deleteRemarkUnfilteredList_success() {
        ...
        PersonBuilder personInList = new PersonBuilder(lastPerson);
        Person editedPerson = personInList.withRemark("").build();
